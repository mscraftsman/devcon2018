...
module.exports = {
  head: {
    ...
    meta: [
      ...
      { hid: 'og:description', property: 'og:description', content: 'Developers Conference 2018 Official Website' },
      ...
      { hid: 'twitter:description', name: 'twitter:description', content: 'Developers Conference 2018 Official Website' },
      ...
      { name: 'theme-color', content: '#004a8f' },
      { name: 'msapplication-TileColor', content: '#004a8f' },
      ...
      { hid: 'description', itemprop: 'description', content: 'Developers Conference 2018 Official Website' },
    ...
    link: [
      ...
      { rel: 'publisher', href: 'https:/plus.google.com/+lexpressmu' }
    ]
  },
