<template>
<div>
  <div class="full-section-container dark">
    <div class="description-container">
      ...
      <div class="content-wrapper">
        ...
        <div class="section-description-wrapper">
          ...
          <p>As previously, the event is a free of charge, community-driven, three-days  IT  tech  conference  hosted  annually  in  Mauritius.  It’s  an  event  full of business opportunities and professional networking. Attendees can learn  about  latest  software  development  technologies,  methodologies,  as  well as cloud features and infrastructure.</p>
  ...
  * {
  ...
  .description-container {
    ...
    .image-wrapper {
      grid-column: 1 / 2;
      grid-row: 1 / 2;
      background: linear-gradient(135deg, transparent, rgba(0, 0, 0, 1)), url(~/static/images/home-bg-2.jpg);
